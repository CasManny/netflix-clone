...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
      <header className="max-w-6xl flex mx-auto items-center justify-between p-4 pb-10">
        <img src="/netflix-logo.png" alt="logo" className="w-32 md:w-52" />
        <Link to={"/login"} className="text-white bg-red-600 px-2 rounded">
          Sign in
        </Link>
      </header>
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        <h1 className="text-4xl mb-4">Unlimited movies, Tv shows and more</h1>
        ...
        <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleSubmit}>
          <input
            ...
            className="p-2 rounded flex-1 border border-gray-200 text-black"
            value={email}
      ...
      {/* {first section} */}
      <div className="h-2 w-full bg-[#423223]" aria-hidden="true" />
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Watch on start TVs, playstations, xbox, chromecast, Apple Tv,
      ...
      <div className="h-2 w-full bg-[#423223]" aria-hidden="true" />
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center md:flex-row justify-center flex-row-reverse px-4 md:px-2">
          {/* left side  */}
          <div className="flex-1 relative">
