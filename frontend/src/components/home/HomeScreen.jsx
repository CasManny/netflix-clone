    ...
    <>
      <div className="relative h-screen text-white">
        ...
        <img
          ...
          alt="image"
          className="absolute top-0 left-0 object-cover h-full w-full -z-50"
          onLoad={() => {
            setImgLoading(false)
          }}
        />
        <div
          className="h-full w-full absolute top-0 left-0 -z-50 bg-black/50"
          aria-hidden="true"
        />

        <div className="h-full w-full top-0 left-0 absolute flex flex-col justify-center px-8 md:px-16 lg:px-32 ">
